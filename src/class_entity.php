...
class class_entity implements iclass_entity
{
  ...
  public function set_generators($generators)
  {
    if (!empty($generators) && is_array($generators))
    {
      foreach ($generators as $classname => $generator)
      {
        ...
        // elseif (is_array($generator) && is_string($classname))
        // {
        //   $this->set_class_generator($classname, $generator);
        // }
      }
    }
    return $this;
  ...
  // protected function set_class_generator($name, $generators)
  // {
  //   if ($this->allowed_generators($generators))
  // }
  ...
  // public function allowed_generators($generators)
  // {
  //   $status = TRUE;
